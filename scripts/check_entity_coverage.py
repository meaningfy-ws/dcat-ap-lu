...
def main():
    ...
    parser.add_argument("shacl_file", help="File with SHACL-defined entities (one per line)")
    parser.add_argument("rdf_file", help="File with RDF-used entities (one per line)")
    parser.add_argument("--label", default="Entity", help="Label for the type of entity (e.g., Class, Property)")
